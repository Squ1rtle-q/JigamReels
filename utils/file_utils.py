...
def safe_filename(filename: str) -> str:
    """
    Очищает имя файла от недопустимых символов, сохраняя пробелы.
    
    Args:
        filename: Исходное имя файла
        
    Returns:
        Безопасное имя файла с допустимыми символами
    """
    # Удаляем только запрещенные символы: \ / : * ? " < > | [ ]
    # Пробелы сохраняются для читаемости
    import re
    ...
    # Убираем множественные пробелы и заменяем двойные пробелы на одинарные
